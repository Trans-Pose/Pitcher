...
public partial class GameEntity {
    ...
    public void AddPosition2D(UnityEngine.Vector2 newValue) {
        var index = GameComponentsLookup.Position2D;
        var component = (Position2D)CreateComponent(index, typeof(Position2D));
        component.Value = newValue;
        AddComponent(index, component);
    }

    public void ReplacePosition2D(UnityEngine.Vector2 newValue) {
        var index = GameComponentsLookup.Position2D;
        var component = (Position2D)CreateComponent(index, typeof(Position2D));
        component.Value = newValue;
